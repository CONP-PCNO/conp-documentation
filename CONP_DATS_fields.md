...
|types|**REQUIRED**. Terms to describe the nature of the data. Data type can be single or multiple. Add a term if needed with the [interlex URI](https://neuinfo.org/interlex/dashboard) if possible.| 
