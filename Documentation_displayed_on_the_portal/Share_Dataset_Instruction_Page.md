...
- [1) Installation of DataLad](#datalad_install)
- [2) Creation of a new DataLad dataset](#dataset_creation)
- [3) Population of the new dataset](#dataset_population)
- [4) Publication of the new dataset to GitHub](#dataset_publication)
- [5) Test of the new dataset before adding it to the conp-dataset DataLad super dataset](#dataset_test)
- [6) Obtention of a Digital Object Identifier (DOI) for your dataset](#doi_obtention)
- [7) Add the new dataset to the list of CONP datasets](#addition_to_conp-dataset) (a.k.a. https://github.com/CONP-PCNO/conp-dataset)

#### <a name="datalad_install"></a> 1) Installation of DataLad
...
#### <a name="dataset_creation"></a> 2) Creation of a new DataLad dataset

The first step to upload a dataset to CONP via DataLad requires the creation of a new DataLad dataset that will be tracked on GitHub.
...
#### <a name="dataset_population"></a> 3) Population of the new dataset
...
- For metadata files (a.k.a. `README.md`, `DATS.json`, logo files), use `git` so that they are not annexed and readable by the CONP portal and users: 
...
#### <a name="dataset_publication"></a> 4) Publication of the new dataset to GitHub
...
#### <a name="dataset_test"></a> 5) Test of the new dataset before adding it to the [CONP-PCNO/conp-dataset](https://github.com/CONP-PCNO/conp-dataset) DataLad super dataset
...
#### <a name="doi_obtention"></a> 6) Obtention of a Digital Object Identifier (DOI) for your dataset
...
- Select the new dataset GitHub repository in the [list of GitHub repositories](https://zenodo.org/account/settings/github) of Zenodo.
...
#### <a name="addition_to_conp-dataset"></a> 7) Add the new dataset to the list of CONP datasets
